...
//            _cachedButtons.Add(EProjectCategory.PC_Challenge, _cachedView.ButtonTagHighpoint);
        ...
        {
            GM2DGUIManager.Instance.OpenUI<UICtrlGameDownloadPriceSetting>(_downloadPrice);
        }
...
//            }
        ...
        {
            GM2DGUIManager.Instance.CloseUI<UICtrlPublish>();
        }
...
//            }
            ...
            SocialGUIManager.Instance.GetUI<UICtrlLittleLoading>().OpenLoading(GM2DGUIManager.Instance.GetUI<UICtrlPublish>(), "作品正在保存中");
