...
{
    public partial class CameraManager0 : IDisposable
    {
        #region private

        private static CameraManager0 _instance;
        ...
        public static CameraManager0 Instance
        {
            get { return _instance ?? (_instance = new CameraManager0()); }
        }
        ...
        public Vector3 MainCameraPos
        {
            ...
            set { _mainCamaraTrans.position = value; }
        }
        ...
        public void Dispose()
        {
            ...
            {
                Object.Destroy(_mainCamaraTrans.gameObject);
            }
            if (_instance != null)
            {
...
//            _cameraViewRect.height = ConstDefineGM2D.CameraOrthoSizeOnPlay * 2;
//            _cameraViewRect.width = _cameraViewRect.height * GM2DGame.Instance.GameScreenAspectRatio;
