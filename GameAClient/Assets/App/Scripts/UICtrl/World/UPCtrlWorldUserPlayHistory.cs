/********************************************************************
** Filename : UPCtrlWorldUserPlayHistory.cs
** Author : quan
** Date : 6/7/2017 3:30 PM
** Summary : UPCtrlWorldUserPlayHistory.cs
***********************************************************************/
...
namespace GameA
{
    public class UPCtrlWorldUserPlayHistory : UPCtrlBase<UICtrlWorld, UIViewWorld>, IOnChangeHandler<long>
    {
        #region 常量与字段
        ...
        {
            return DateTimeUtil.GetServerSmartDateStringByTimestampMillis(p.ProjectUserData.LastPlayTime);
        }
        #region private
        ...
        private void RefreshView()
        {
            ...
            _cachedView.PlayHistoryGridScroller.SetItemCount(_contentList.Count);
        }
