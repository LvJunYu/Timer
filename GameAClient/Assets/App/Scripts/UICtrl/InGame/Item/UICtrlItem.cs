...
namespace GameA
{
    ...
    public class UICtrlItem : UICtrlInGameBase<UIViewItem>
    {
        ...
        {
            base.OnDestroy();
            _cachedView.Actor.onClick.RemoveListener(OnActor);
            _cachedView.Earth.onClick.RemoveListener(OnEarth);
            _cachedView.Mechanism.onClick.RemoveListener(OnMechanism);
            _cachedView.Monster.onClick.RemoveListener(OnMonster);
            _cachedView.Collection.onClick.RemoveListener(OnCollection);
            _cachedView.Decoration.onClick.RemoveListener(OnDecoration);
		}
