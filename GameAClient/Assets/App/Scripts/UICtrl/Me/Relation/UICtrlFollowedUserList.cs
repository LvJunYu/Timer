  /********************************************************************
  ** Filename : UICtrlFollowUserList.cs
  ** Author : quan
  ** Date : 2016/6/10 10:01
  ** Summary : UICtrlFollowUserList.cs
  ***********************************************************************/
...
namespace GameA
{
    ...
    public class UICtrlFollowedUserList : UISocialContentCtrlBase<UIViewFollowedUserList>, IUIWithTitle
    {
        #region 常量与字段
        ...
        protected override void OnOpen(object parameter)
        {
            ...
            _requestTimer = user.FollowedListRequestTimer;
            if(user == null)
            {
                LogHelper.Error("UICtrlFollowedUserList onOpen error, param is null");
                return;
            }
            if(_user != user)
            {
        ...
        private void RequestData(bool append = false)
        {
            ...
            _isRequest = true;
//            Msg_CA_RequestFollow msg = new Msg_CA_RequestFollow();
...
//            User user = _user;
//            NetworkManager.AppHttpClient.SendWithCb<Msg_AC_UserInfoList>(SoyHttpApiPath.GetFollowList, msg, ret=>{
//                _isRequest = false;
//                user.OnSyncFollowList(ret);
//                if(user == _user)
//                {
//                    _content = _user.FollowedList;
//                    if(!append)
//                    {
//                        _requestTimer.Reset();
//                        _cachedView.RefreshController.ExitRefresh();
