  /********************************************************************
  ** Filename : UICommentScrollHelper.cs
  ** Author : quan
  ** Date : 11/24/2016 7:38 PM
  ** Summary : UICommentScrollHelper.cs
  ***********************************************************************/
...
namespace GameA
{
    public class UICommentScrollHelper : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        [SerializeField]
