...
namespace GameA
{
    public partial class UserPublishedWorldProjectList : SyncronisticData<Msg_SC_DAT_UserPublishedWorldProjectList> {
        #region 字段
        // sc fields----------------------------------
        /// <summary>
        /// ECachedDataState
        ...
        public bool CopyMsgData (Msg_SC_DAT_UserPublishedWorldProjectList msg)
        {
            if (null == msg) return false;
            _resultCode = msg.ResultCode;           
            _updateTime = msg.UpdateTime;           
