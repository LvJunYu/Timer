...
namespace GameA
{
    public partial class WorldProjectRecentRecordList : SyncronisticData<Msg_SC_DAT_WorldProjectRecentRecordList> {
        #region 字段
        // sc fields----------------------------------
        /// <summary>
        /// ECachedDataState
        ...
        public bool CopyMsgData (Msg_SC_DAT_WorldProjectRecentRecordList msg)
        {
            if (null == msg) return false;
            _resultCode = msg.ResultCode;           
            _updateTime = msg.UpdateTime;           
        ...
        public WorldProjectRecentRecordList (Msg_SC_DAT_WorldProjectRecentRecordList msg) {
            if (OnSync(msg)) {
                OnSyncSucceed();
            }
        }
