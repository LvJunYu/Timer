...
namespace GameA
{
    public partial class WorldSelfRecommendProjectList : SyncronisticData<Msg_SC_DAT_WorldSelfRecommendProjectList> {
        #region 字段
        // sc fields----------------------------------
        /// <summary>
        /// ECachedDataState
            ...
            Action successCallback, Action<ENetResultCode> failedCallback)
        {
            if (_isRequesting) {
                ...
                Msg_CS_DAT_WorldSelfRecommendProjectList msg = new Msg_CS_DAT_WorldSelfRecommendProjectList();
                msg.StartInx = startInx;
                msg.MaxCount = maxCount;
                msg.ProjectTypeMask = projectTypeMask;
                NetworkManager.AppHttpClient.SendWithCb<Msg_SC_DAT_WorldSelfRecommendProjectList>(
                    SoyHttpApiPath.WorldSelfRecommendProjectList, msg, ret => {
                        if (OnSync(ret)) {
                            OnSyncSucceed(); 
                        }
        ...
        public bool OnSync (Msg_SC_DAT_WorldSelfRecommendProjectList msg)
        {
        ...
        public bool CopyMsgData (Msg_SC_DAT_WorldSelfRecommendProjectList msg)
        {
            if (null == msg) return false;
            _resultCode = msg.ResultCode;           
            _updateTime = msg.UpdateTime;           
        ...
        public bool DeepCopy (WorldSelfRecommendProjectList obj)
        {
        ...
        public void OnSyncFromParent (Msg_SC_DAT_WorldSelfRecommendProjectList msg) {
            if (OnSync(msg)) {
                OnSyncSucceed();
            }
        }

        public WorldSelfRecommendProjectList (Msg_SC_DAT_WorldSelfRecommendProjectList msg) {
            if (OnSync(msg)) {
                OnSyncSucceed();
            }
        }

        public WorldSelfRecommendProjectList () { 
            _projectList = new List<Project>();
            OnCreate();
        }
        #endregion
