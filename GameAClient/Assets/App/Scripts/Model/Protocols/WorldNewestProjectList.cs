...
namespace GameA
{
    public partial class WorldNewestProjectList : SyncronisticData<Msg_SC_DAT_WorldNewestProjectList> {
        #region 字段
        // sc fields----------------------------------
        /// <summary>
        /// ECachedDataState
        ...
        public bool CopyMsgData (Msg_SC_DAT_WorldNewestProjectList msg)
        {
            if (null == msg) return false;
            _resultCode = msg.ResultCode;           
            _updateTime = msg.UpdateTime;           
        ...
        public bool DeepCopy (WorldNewestProjectList obj)
        {
