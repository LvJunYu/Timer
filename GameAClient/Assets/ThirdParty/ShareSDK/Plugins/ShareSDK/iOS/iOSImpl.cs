...
namespace cn.sharesdk.unity3d
{
	...
	public class iOSImpl : ShareSDKImpl
	{
		...
		{
			String json = ShareSDKNS.MiniJSON.jsonEncode(configs);
		...
		public override void ShareContent (int reqID, PlatformType[] platforms, ShareContent content) 
		{
			...
			if (platforms != null)
			{
				...
				platTypesStr = ShareSDKNS.MiniJSON.jsonEncode(platTypesArr.ToArray());
			}
		...
		{
            String customFieldsStr = ShareSDKNS.MiniJSON.jsonEncode(customFields);
		...
		public override Hashtable GetAuthInfo (PlatformType platform) 
		{
			...
			Hashtable authInfo = (Hashtable)ShareSDKNS.MiniJSON.jsonDecode (credStr);
			return authInfo;
		}
