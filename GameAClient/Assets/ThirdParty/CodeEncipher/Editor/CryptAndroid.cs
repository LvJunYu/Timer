...
namespace J3Tech
{
	public class CryptAndroid
	{
	    ...
	    {
#if UNITY_5
            PluginImporter pluginImporter = AssetImporter.GetAtPath("Assets/CodeEncipher/Editor/Plugin/CryptAndroid.dll") as PluginImporter;
            if (pluginImporter != null)
            {
                pluginImporter.SetCompatibleWithEditor(true);
                pluginImporter.SaveAndReimport();
            }
            pluginImporter = AssetImporter.GetAtPath("Assets/CodeEncipher/Editor/Plugin/CryptAndroidX64.dll") as PluginImporter;
            if (pluginImporter != null)
            {
                pluginImporter.SetCompatibleWithEditor(true);
                pluginImporter.SaveAndReimport();
