...
namespace SoyEngine
{
    public static class SoyHttpApiPath
    {
        ...
        // 推荐关卡
        public const string WorldOfficialRecommendProjectList = "/world/getOfficialRecommendProjectList";
        // 录像
        ...
        // 修改账号角色
        public const string GmUpdateAccountRoleType = "/gm/updateAccountRoleType";
        // 查询所有GM
        public const string GameMasterList = "/gm/getGameMasterList";
        // 获取编辑区官方推荐关卡
        public const string WorldOfficialRecommendPrepareProjectList = "/gm/getOfficialRecommendPrepareProjectList";
        // 推荐关卡候选
        public const string WorldOfficialRecommendCandidateProjectList = "/gm/getOfficialRecommendCandidateProjectList";
        // 获取关卡推荐状态
        public const string GmProjectOfficialRecommendStatus = "/gm/getProjectOfficialRecommendStatus";
        // 更改关卡推荐状态
        public const string GmUpdateProjectOfficialRecommendStatus = "/gm/updateProjectOfficialRecommendStatus";
        // 排序官方推荐编辑区
        public const string SortOfficialRecommendProjectPrepare = "/gm/sortOfficialRecommendProjectPrepare";
        // 升级推荐编辑区关卡到最新
        public const string GmUpgradeOfficialRecommendProject = "/gm/upgradeOfficialRecommendProject";
        // 发布官方推荐关卡
        public const string GmPublishOfficialRecommendProject = "/gm/publishOfficialRecommendProject";
        // 获取官方推荐关卡当前发布时间
        public const string GmOfficialRecommendProjectPublishTime = "/gm/getOfficialRecommendProjectPublishTime";
        // 获取官方工坊发布关卡
        public const string GmMasterProjectList = "/gm/getMasterProjectList";
        // 编辑区冒险模式关卡列表
        public const string GmAdventureProjectPrepareList = "/gm/getAdventureProjectPrepareList";
        // 编辑编辑区冒险模式关卡
        public const string GmUpdateAdventureProjectPrepare = "/gm/updateAdventureProjectPrepare";
        // 获取冒险关卡发布时间
        public const string GmAdventureProjectPublishTime = "/gm/getAdventureProjectPublishTime";
        // 发布冒险关卡
        public const string GmPublishAdventureProject = "/gm/publishAdventureProject";
        // 上传冒险关卡
        public const string GmUploadAdventureProject = "/gm/uploadAdventureProject";
        // 编辑区多人关卡列表
        public const string GmNetProjectPrepareList = "/gm/getNetProjectPrepareList";
        // 编辑编辑区多人关卡
        public const string GmUpdateNetProjectPrepare = "/gm/updateNetProjectPrepare";
        // 获取多人关卡发布时间
        public const string GmNetProjectPublishTime = "/gm/getNetProjectPublishTime";
        // 发布多人关卡
        public const string GmPublishNetProject = "/gm/publishNetProject";
        // 上传多人关卡
        public const string GmUploadNetProject = "/gm/uploadNetProject";
        // 编辑区剧情关卡列表
        public const string GmRpgProjectPrepareList = "/gm/getRpgProjectPrepareList";
        // 编辑编辑区剧情关卡
        public const string GmUpdateRpgProjectPrepare = "/gm/updateRpgProjectPrepare";
        // 获取剧情关卡发布时间
        public const string GmRpgProjectPublishTime = "/gm/getRpgProjectPublishTime";
        // 发布剧情关卡
        public const string GmPublishRpgProject = "/gm/publishRpgProject";
        // 上传剧情关卡
        public const string GmUploadRpgProject = "/gm/uploadRpgProject";
        // 上传冒险关卡列表
        public const string InternalUploadAdventureProjectList = "/gm/internalUploadAdventureProjectList";
        // 上传冒险关卡
        public const string InternalUploadAdventureProject = "/gm/internalUploadAdventureProject";
        // 发布冒险关卡
        public const string InternalPublishAdventureProject = "/gm/internalPublishAdventureProject";
        // 上传多人关卡列表
        public const string InternalUploadNetProjectList = "/gm/internalUploadNetProjectList";
        // 上传多人关卡
        public const string InternalUploadNetProject = "/gm/internalUploadNetProject";
        // 发布多人关卡
        public const string InternalPublishNetProject = "/gm/internalPublishNetProject";
        // 上传剧情关卡列表
        public const string InternalUploadRpgProjectList = "/gm/internalUploadRpgProjectList";
        // 上传剧情关卡
        public const string InternalUploadRpgProject = "/gm/internalUploadRpgProject";
        // 发布剧情关卡
        public const string InternalPublishRpgProject = "/gm/internalPublishRpgProject";
    }
}