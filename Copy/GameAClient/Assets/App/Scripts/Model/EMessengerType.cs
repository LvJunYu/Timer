...
namespace GameA
{
    public static partial class EMessengerType
    {
        ...
        //世界GM官方推荐面板
        public static readonly int OnWorldOfficalRecommendEditBtn = SoyEngine.EMessengerType.NextId++;

        public static readonly int OnWorldOfficalRecommendCancelBtn = SoyEngine.EMessengerType.NextId++;
    }
}