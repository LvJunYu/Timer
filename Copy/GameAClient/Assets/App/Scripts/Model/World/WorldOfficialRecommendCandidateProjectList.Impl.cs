...
namespace GameA
{
    public partial class WorldOfficialRecommendCandidateProjectList
    {
        ...
        protected override void OnSyncPartial(Msg_SC_DAT_WorldOfficialRecommendCandidateProjectList msg)
        {
