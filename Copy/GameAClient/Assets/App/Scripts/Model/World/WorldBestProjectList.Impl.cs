...
namespace GameA
{
    public partial class WorldBestProjectList
    {
        ...
        protected override void OnSyncPartial(Msg_SC_DAT_WorldBestProjectList msg)
        {
        ...
        protected override void OnSyncPartial()
        {
            ...
            if (_resultCode == (int) ECachedDataState.CDS_None || _resultCode == (int) ECachedDataState.CDS_Uptodate)
            {
                ...
                {
                    IsEnd = true;
                    MessengerAsync.Broadcast(EMessengerType.OnWorldBestProjectListChanged);
                }
                return;
            }
