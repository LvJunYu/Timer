...
namespace GameA
{
    ...
    public partial class Project
    {
        ...
        private bool _isGmProject;

        public bool IsGmProject
        {
            get { return _isGmProject; }
            set { _isGmProject = value; }
        }
        ...
        public static int ProjectTypeSingle = 1;
        public static int ProjectTypeAllMulti = (1 << 1) | (1 << 2);
        ...
        public int NewestProjectVersion
        {
            get
            {
                if (_extendData != null)
                {
                    return _extendData.NewestProjectVersion;
                }
                else
                {
                    return 0;
...
//            });
            ...
            Action<ENetResultCode> failedCallback = null)
        {
            ...
            RemoteCommands.UpdateWorldProjectFavorite(_projectId, favorite, ret =>
            {
                ...
                Messenger<Project, bool>.Broadcast(EMessengerType.OnProjectMyFavoriteChanged, this,
                    _projectUserData.Favorite);
                if (successCallback != null)
                {
                    successCallback.Invoke();
                }
