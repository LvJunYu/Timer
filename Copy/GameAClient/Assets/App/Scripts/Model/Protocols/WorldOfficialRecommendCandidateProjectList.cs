...
namespace GameA
{
    public partial class WorldOfficialRecommendCandidateProjectList : SyncronisticData<Msg_SC_DAT_WorldOfficialRecommendCandidateProjectList> {
        #region 字段
        // sc fields----------------------------------
        /// <summary>
        /// ECachedDataState
            ...
            Action successCallback, Action<ENetResultCode> failedCallback)
        {
            if (_isRequesting) {
                ...
                Msg_CS_DAT_WorldOfficialRecommendCandidateProjectList msg = new Msg_CS_DAT_WorldOfficialRecommendCandidateProjectList();
                msg.StartInx = startInx;
                msg.MaxCount = maxCount;
                NetworkManager.AppHttpClient.SendWithCb<Msg_SC_DAT_WorldOfficialRecommendCandidateProjectList>(
                    SoyHttpApiPath.WorldOfficialRecommendCandidateProjectList, msg, ret => {
                        if (OnSync(ret)) {
                            OnSyncSucceed(); 
                        }
        ...
        public bool OnSync (Msg_SC_DAT_WorldOfficialRecommendCandidateProjectList msg)
        {
        ...
        public bool CopyMsgData (Msg_SC_DAT_WorldOfficialRecommendCandidateProjectList msg)
        {
            if (null == msg) return false;
            _resultCode = msg.ResultCode;           
            _updateTime = msg.UpdateTime;           
        ...
        public bool DeepCopy (WorldOfficialRecommendCandidateProjectList obj)
        {
        ...
        public void OnSyncFromParent (Msg_SC_DAT_WorldOfficialRecommendCandidateProjectList msg) {
            if (OnSync(msg)) {
                OnSyncSucceed();
            }
        }

        public WorldOfficialRecommendCandidateProjectList (Msg_SC_DAT_WorldOfficialRecommendCandidateProjectList msg) {
            if (OnSync(msg)) {
                OnSyncSucceed();
            }
        }

        public WorldOfficialRecommendCandidateProjectList () { 
            _projectList = new List<WorldOfficialRecommendPrepareProject>();
            OnCreate();
        }
        #endregion
