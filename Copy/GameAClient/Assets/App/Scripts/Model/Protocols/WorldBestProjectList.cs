...
namespace GameA
{
    public partial class WorldBestProjectList : SyncronisticData<Msg_SC_DAT_WorldBestProjectList> {
        #region 字段
        // sc fields----------------------------------
        /// <summary>
        /// ECachedDataState
            ...
            Action successCallback, Action<ENetResultCode> failedCallback)
        {
            if (_isRequesting) {
                ...
                Msg_CS_DAT_WorldBestProjectList msg = new Msg_CS_DAT_WorldBestProjectList();
                msg.StartInx = startInx;
                msg.MaxCount = maxCount;
                msg.ProjectTypeMask = projectTypeMask;
                NetworkManager.AppHttpClient.SendWithCb<Msg_SC_DAT_WorldBestProjectList>(
                    SoyHttpApiPath.WorldBestProjectList, msg, ret => {
                        if (OnSync(ret)) {
                            OnSyncSucceed(); 
                        }
        ...
        public bool OnSync (Msg_SC_DAT_WorldBestProjectList msg)
        {
        ...
        public bool CopyMsgData (Msg_SC_DAT_WorldBestProjectList msg)
        {
            if (null == msg) return false;
            _resultCode = msg.ResultCode;           
            _updateTime = msg.UpdateTime;           
        ...
        public bool DeepCopy (WorldBestProjectList obj)
        {
        ...
        public void OnSyncFromParent (Msg_SC_DAT_WorldBestProjectList msg) {
            if (OnSync(msg)) {
                OnSyncSucceed();
            }
        }

        public WorldBestProjectList (Msg_SC_DAT_WorldBestProjectList msg) {
            if (OnSync(msg)) {
                OnSyncSucceed();
            }
        }

        public WorldBestProjectList () { 
            _projectList = new List<Project>();
            OnCreate();
        }
        #endregion
