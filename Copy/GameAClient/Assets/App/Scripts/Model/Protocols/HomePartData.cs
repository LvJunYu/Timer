...
namespace GameA
{
    public partial class HomePartData : SyncronisticData<Msg_SC_DAT_HomePartData> {
        #region 字段
        // sc fields----------------------------------
        /// <summary>
        /// 用户
        ...
        public bool CopyMsgData (Msg_SC_DAT_HomePartData msg)
        {
            if (null == msg) return false;
            _userId = msg.UserId;           
            if (null ==  _itemDataList) {
        ...
        public bool DeepCopy (HomePartData obj)
        {
