...
namespace GameA
{
    public partial class GmMasterProjectList : SyncronisticData<Msg_SC_DAT_GmMasterProjectList> {
        #region 字段
        // sc fields----------------------------------
        /// <summary>
        /// ECachedDataState
            ...
            Action successCallback, Action<ENetResultCode> failedCallback)
        {
            if (_isRequesting) {
                ...
                Msg_CS_DAT_GmMasterProjectList msg = new Msg_CS_DAT_GmMasterProjectList();
                msg.StartInx = startInx;
                msg.MaxCount = maxCount;
                msg.ProjectTypeMask = projectTypeMask;
                NetworkManager.AppHttpClient.SendWithCb<Msg_SC_DAT_GmMasterProjectList>(
                    SoyHttpApiPath.GmMasterProjectList, msg, ret => {
                        if (OnSync(ret)) {
                            OnSyncSucceed(); 
                        }
        ...
        public bool OnSync (Msg_SC_DAT_GmMasterProjectList msg)
        {
        ...
        public bool CopyMsgData (Msg_SC_DAT_GmMasterProjectList msg)
        {
            if (null == msg) return false;
            _resultCode = msg.ResultCode;           
            _updateTime = msg.UpdateTime;           
        ...
        public bool DeepCopy (GmMasterProjectList obj)
        {
        ...
        public void OnSyncFromParent (Msg_SC_DAT_GmMasterProjectList msg) {
            if (OnSync(msg)) {
                OnSyncSucceed();
            }
        }

        public GmMasterProjectList (Msg_SC_DAT_GmMasterProjectList msg) {
            if (OnSync(msg)) {
                OnSyncSucceed();
            }
        }

        public GmMasterProjectList () { 
            _projectList = new List<Project>();
            OnCreate();
        }
        #endregion
