...
namespace GameA
{
    public partial class GmNetProjectPrepareList : SyncronisticData<Msg_SC_DAT_GmNetProjectPrepareList> {
        #region 字段
        // sc fields----------------------------------
        /// <summary>
        /// ECachedDataState
            ...
            Action successCallback, Action<ENetResultCode> failedCallback)
        {
            if (_isRequesting) {
                ...
                Msg_CS_DAT_GmNetProjectPrepareList msg = new Msg_CS_DAT_GmNetProjectPrepareList();
                msg.StartInx = startInx;
                msg.MaxCount = maxCount;
                NetworkManager.AppHttpClient.SendWithCb<Msg_SC_DAT_GmNetProjectPrepareList>(
                    SoyHttpApiPath.GmNetProjectPrepareList, msg, ret => {
                        if (OnSync(ret)) {
                            OnSyncSucceed(); 
                        }
        ...
        public bool OnSync (Msg_SC_DAT_GmNetProjectPrepareList msg)
        {
        ...
        public bool CopyMsgData (Msg_SC_DAT_GmNetProjectPrepareList msg)
        {
            if (null == msg) return false;
            _resultCode = msg.ResultCode;           
            _updateTime = msg.UpdateTime;           
        ...
        public bool DeepCopy (GmNetProjectPrepareList obj)
        {
        ...
        public void OnSyncFromParent (Msg_SC_DAT_GmNetProjectPrepareList msg) {
            if (OnSync(msg)) {
                OnSyncSucceed();
            }
        }

        public GmNetProjectPrepareList (Msg_SC_DAT_GmNetProjectPrepareList msg) {
            if (OnSync(msg)) {
                OnSyncSucceed();
            }
        }

        public GmNetProjectPrepareList () { 
            _projectList = new List<GmPrepareProject>();
            OnCreate();
        }
        #endregion
