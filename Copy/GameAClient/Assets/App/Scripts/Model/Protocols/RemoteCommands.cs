...
namespace GameA
{
    public class RemoteCommands {
		...
		/// <param name="isMaster">是否官方工坊</param>
        ...
        public static bool IsRequstingGmUpdateAccountRoleType {
            get { return _isRequstingGmUpdateAccountRoleType; }
        }
        private static bool _isRequstingGmUpdateAccountRoleType = false;
        /// <summary>
		/// 修改账号角色
		/// </summary>
		/// <param name="userId">用户</param>
		/// <param name="role">角色</param>
        public static void GmUpdateAccountRoleType (
            long userId,
            EAccountRoleType role,
            Action<Msg_SC_CMD_GmUpdateAccountRoleType> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmUpdateAccountRoleType) {
                return;
            }
            _isRequstingGmUpdateAccountRoleType = true;
            Msg_CS_CMD_GmUpdateAccountRoleType msg = new Msg_CS_CMD_GmUpdateAccountRoleType();
            // 修改账号角色
            msg.UserId = userId;
            msg.Role = role;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmUpdateAccountRoleType>(
                SoyHttpApiPath.GmUpdateAccountRoleType, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmUpdateAccountRoleType = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmUpdateAccountRoleType", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmUpdateAccountRoleType = false;
        ...
        public static bool IsRequstingGmUpdateProjectOfficialRecommendStatus {
            get { return _isRequstingGmUpdateProjectOfficialRecommendStatus; }
        }
        private static bool _isRequstingGmUpdateProjectOfficialRecommendStatus = false;
        /// <summary>
		/// 更改关卡推荐状态
		/// </summary>
		/// <param name="projectMainIdList">关卡id</param>
		/// <param name="status">状态</param>
        public static void GmUpdateProjectOfficialRecommendStatus (
            List<long> projectMainIdList,
            EOfficialRecommendProjectStatus status,
            Action<Msg_SC_CMD_GmUpdateProjectOfficialRecommendStatus> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmUpdateProjectOfficialRecommendStatus) {
                return;
            }
            _isRequstingGmUpdateProjectOfficialRecommendStatus = true;
            Msg_CS_CMD_GmUpdateProjectOfficialRecommendStatus msg = new Msg_CS_CMD_GmUpdateProjectOfficialRecommendStatus();
            // 更改关卡推荐状态
            msg.ProjectMainIdList.AddRange(projectMainIdList);
            msg.Status = status;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmUpdateProjectOfficialRecommendStatus>(
                SoyHttpApiPath.GmUpdateProjectOfficialRecommendStatus, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmUpdateProjectOfficialRecommendStatus = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmUpdateProjectOfficialRecommendStatus", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmUpdateProjectOfficialRecommendStatus = false;
        ...
        public static bool IsRequstingSortOfficialRecommendProjectPrepare {
            get { return _isRequstingSortOfficialRecommendProjectPrepare; }
        }
        private static bool _isRequstingSortOfficialRecommendProjectPrepare = false;
        /// <summary>
		/// 排序官方推荐编辑区
		/// </summary>
		/// <param name="sortItemList">关卡</param>
        public static void SortOfficialRecommendProjectPrepare (
            List<Msg_SortOfficialRecommendProjectPrepareItem> sortItemList,
            Action<Msg_SC_CMD_SortOfficialRecommendProjectPrepare> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingSortOfficialRecommendProjectPrepare) {
                return;
            }
            _isRequstingSortOfficialRecommendProjectPrepare = true;
            Msg_CS_CMD_SortOfficialRecommendProjectPrepare msg = new Msg_CS_CMD_SortOfficialRecommendProjectPrepare();
            // 排序官方推荐编辑区
            msg.SortItemList.AddRange(sortItemList);
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_SortOfficialRecommendProjectPrepare>(
                SoyHttpApiPath.SortOfficialRecommendProjectPrepare, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingSortOfficialRecommendProjectPrepare = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "SortOfficialRecommendProjectPrepare", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingSortOfficialRecommendProjectPrepare = false;
        ...
        public static bool IsRequstingGmUpgradeOfficialRecommendProject {
            get { return _isRequstingGmUpgradeOfficialRecommendProject; }
        }
        private static bool _isRequstingGmUpgradeOfficialRecommendProject = false;
        /// <summary>
		/// 升级推荐编辑区关卡到最新
		/// </summary>
		/// <param name="recommendId">推荐Id</param>
        public static void GmUpgradeOfficialRecommendProject (
            List<long> recommendId,
            Action<Msg_SC_CMD_GmUpgradeOfficialRecommendProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmUpgradeOfficialRecommendProject) {
                return;
            }
            _isRequstingGmUpgradeOfficialRecommendProject = true;
            Msg_CS_CMD_GmUpgradeOfficialRecommendProject msg = new Msg_CS_CMD_GmUpgradeOfficialRecommendProject();
            // 升级推荐编辑区关卡到最新
            msg.RecommendId.AddRange(recommendId);
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmUpgradeOfficialRecommendProject>(
                SoyHttpApiPath.GmUpgradeOfficialRecommendProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmUpgradeOfficialRecommendProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmUpgradeOfficialRecommendProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmUpgradeOfficialRecommendProject = false;
        ...
        public static bool IsRequstingGmPublishOfficialRecommendProject {
            get { return _isRequstingGmPublishOfficialRecommendProject; }
        }
        private static bool _isRequstingGmPublishOfficialRecommendProject = false;
        /// <summary>
		/// 发布官方推荐关卡
		/// </summary>
		/// <param name="publishTime">定时</param>
        public static void GmPublishOfficialRecommendProject (
            long publishTime,
            Action<Msg_SC_CMD_GmPublishOfficialRecommendProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmPublishOfficialRecommendProject) {
                return;
            }
            _isRequstingGmPublishOfficialRecommendProject = true;
            Msg_CS_CMD_GmPublishOfficialRecommendProject msg = new Msg_CS_CMD_GmPublishOfficialRecommendProject();
            // 发布官方推荐关卡
            msg.PublishTime = publishTime;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmPublishOfficialRecommendProject>(
                SoyHttpApiPath.GmPublishOfficialRecommendProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmPublishOfficialRecommendProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmPublishOfficialRecommendProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmPublishOfficialRecommendProject = false;
        ...
        public static bool IsRequstingGmUpdateAdventureProjectPrepare {
            get { return _isRequstingGmUpdateAdventureProjectPrepare; }
        }
        private static bool _isRequstingGmUpdateAdventureProjectPrepare = false;
        /// <summary>
		/// 编辑编辑区冒险模式关卡
		/// </summary>
		/// <param name="itemList">指令列表</param>
        public static void GmUpdateAdventureProjectPrepare (
            List<Msg_GmUpdateAdventureProjectPrepare> itemList,
            Action<Msg_SC_CMD_GmUpdateAdventureProjectPrepare> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmUpdateAdventureProjectPrepare) {
                return;
            }
            _isRequstingGmUpdateAdventureProjectPrepare = true;
            Msg_CS_CMD_GmUpdateAdventureProjectPrepare msg = new Msg_CS_CMD_GmUpdateAdventureProjectPrepare();
            // 编辑编辑区冒险模式关卡
            msg.ItemList.AddRange(itemList);
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmUpdateAdventureProjectPrepare>(
                SoyHttpApiPath.GmUpdateAdventureProjectPrepare, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmUpdateAdventureProjectPrepare = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmUpdateAdventureProjectPrepare", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmUpdateAdventureProjectPrepare = false;
        ...
        public static bool IsRequstingGmPublishAdventureProject {
            get { return _isRequstingGmPublishAdventureProject; }
        }
        private static bool _isRequstingGmPublishAdventureProject = false;
        /// <summary>
		/// 发布冒险关卡
		/// </summary>
		/// <param name="publishTime">定时</param>
        public static void GmPublishAdventureProject (
            long publishTime,
            Action<Msg_SC_CMD_GmPublishAdventureProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmPublishAdventureProject) {
                return;
            }
            _isRequstingGmPublishAdventureProject = true;
            Msg_CS_CMD_GmPublishAdventureProject msg = new Msg_CS_CMD_GmPublishAdventureProject();
            // 发布冒险关卡
            msg.PublishTime = publishTime;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmPublishAdventureProject>(
                SoyHttpApiPath.GmPublishAdventureProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmPublishAdventureProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmPublishAdventureProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmPublishAdventureProject = false;
        ...
        public static bool IsRequstingGmUploadAdventureProject {
            get { return _isRequstingGmUploadAdventureProject; }
        }
        private static bool _isRequstingGmUploadAdventureProject = false;
        /// <summary>
		/// 上传冒险关卡
		/// </summary>
		/// <param name="flag">占位</param>
        public static void GmUploadAdventureProject (
            int flag,
            Action<Msg_SC_CMD_GmUploadAdventureProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmUploadAdventureProject) {
                return;
            }
            _isRequstingGmUploadAdventureProject = true;
            Msg_CS_CMD_GmUploadAdventureProject msg = new Msg_CS_CMD_GmUploadAdventureProject();
            // 上传冒险关卡
            msg.Flag = flag;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmUploadAdventureProject>(
                SoyHttpApiPath.GmUploadAdventureProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmUploadAdventureProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmUploadAdventureProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmUploadAdventureProject = false;
        ...
        public static bool IsRequstingGmUpdateNetProjectPrepare {
            get { return _isRequstingGmUpdateNetProjectPrepare; }
        }
        private static bool _isRequstingGmUpdateNetProjectPrepare = false;
        /// <summary>
		/// 编辑编辑区多人关卡
		/// </summary>
		/// <param name="itemList">指令列表</param>
        public static void GmUpdateNetProjectPrepare (
            List<Msg_GmUpdateNetProjectPrepare> itemList,
            Action<Msg_SC_CMD_GmUpdateNetProjectPrepare> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmUpdateNetProjectPrepare) {
                return;
            }
            _isRequstingGmUpdateNetProjectPrepare = true;
            Msg_CS_CMD_GmUpdateNetProjectPrepare msg = new Msg_CS_CMD_GmUpdateNetProjectPrepare();
            // 编辑编辑区多人关卡
            msg.ItemList.AddRange(itemList);
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmUpdateNetProjectPrepare>(
                SoyHttpApiPath.GmUpdateNetProjectPrepare, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmUpdateNetProjectPrepare = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmUpdateNetProjectPrepare", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmUpdateNetProjectPrepare = false;
        ...
        public static bool IsRequstingGmPublishNetProject {
            get { return _isRequstingGmPublishNetProject; }
        }
        private static bool _isRequstingGmPublishNetProject = false;
        /// <summary>
		/// 发布多人关卡
		/// </summary>
		/// <param name="publishTime">定时</param>
        public static void GmPublishNetProject (
            long publishTime,
            Action<Msg_SC_CMD_GmPublishNetProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmPublishNetProject) {
                return;
            }
            _isRequstingGmPublishNetProject = true;
            Msg_CS_CMD_GmPublishNetProject msg = new Msg_CS_CMD_GmPublishNetProject();
            // 发布多人关卡
            msg.PublishTime = publishTime;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmPublishNetProject>(
                SoyHttpApiPath.GmPublishNetProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmPublishNetProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmPublishNetProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmPublishNetProject = false;
        ...
        public static bool IsRequstingGmUploadNetProject {
            get { return _isRequstingGmUploadNetProject; }
        }
        private static bool _isRequstingGmUploadNetProject = false;
        /// <summary>
		/// 上传多人关卡
		/// </summary>
		/// <param name="flag">占位</param>
        public static void GmUploadNetProject (
            int flag,
            Action<Msg_SC_CMD_GmUploadNetProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmUploadNetProject) {
                return;
            }
            _isRequstingGmUploadNetProject = true;
            Msg_CS_CMD_GmUploadNetProject msg = new Msg_CS_CMD_GmUploadNetProject();
            // 上传多人关卡
            msg.Flag = flag;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmUploadNetProject>(
                SoyHttpApiPath.GmUploadNetProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmUploadNetProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmUploadNetProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmUploadNetProject = false;
        ...
        public static bool IsRequstingGmUpdateRpgProjectPrepare {
            get { return _isRequstingGmUpdateRpgProjectPrepare; }
        }
        private static bool _isRequstingGmUpdateRpgProjectPrepare = false;
        /// <summary>
		/// 编辑编辑区剧情关卡
		/// </summary>
		/// <param name="itemList">指令列表</param>
        public static void GmUpdateRpgProjectPrepare (
            List<Msg_GmUpdateRpgProjectPrepare> itemList,
            Action<Msg_SC_CMD_GmUpdateRgpProjectPrepare> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmUpdateRpgProjectPrepare) {
                return;
            }
            _isRequstingGmUpdateRpgProjectPrepare = true;
            Msg_CS_CMD_GmUpdateRpgProjectPrepare msg = new Msg_CS_CMD_GmUpdateRpgProjectPrepare();
            // 编辑编辑区剧情关卡
            msg.ItemList.AddRange(itemList);
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmUpdateRgpProjectPrepare>(
                SoyHttpApiPath.GmUpdateRpgProjectPrepare, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmUpdateRpgProjectPrepare = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmUpdateRpgProjectPrepare", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmUpdateRpgProjectPrepare = false;
        ...
        public static bool IsRequstingGmPublishRpgProject {
            get { return _isRequstingGmPublishRpgProject; }
        }
        private static bool _isRequstingGmPublishRpgProject = false;
        /// <summary>
		/// 发布剧情关卡
		/// </summary>
		/// <param name="publishTime">定时</param>
        public static void GmPublishRpgProject (
            long publishTime,
            Action<Msg_SC_CMD_GmPublishRpgProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmPublishRpgProject) {
                return;
            }
            _isRequstingGmPublishRpgProject = true;
            Msg_CS_CMD_GmPublishRpgProject msg = new Msg_CS_CMD_GmPublishRpgProject();
            // 发布剧情关卡
            msg.PublishTime = publishTime;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmPublishRpgProject>(
                SoyHttpApiPath.GmPublishRpgProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmPublishRpgProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmPublishRpgProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmPublishRpgProject = false;
        ...
        public static bool IsRequstingGmUploadRpgProject {
            get { return _isRequstingGmUploadRpgProject; }
        }
        private static bool _isRequstingGmUploadRpgProject = false;
        /// <summary>
		/// 上传剧情关卡
		/// </summary>
		/// <param name="flag">占位</param>
        public static void GmUploadRpgProject (
            int flag,
            Action<Msg_SC_CMD_GmUploadRpgProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingGmUploadRpgProject) {
                return;
            }
            _isRequstingGmUploadRpgProject = true;
            Msg_CS_CMD_GmUploadRpgProject msg = new Msg_CS_CMD_GmUploadRpgProject();
            // 上传剧情关卡
            msg.Flag = flag;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_GmUploadRpgProject>(
                SoyHttpApiPath.GmUploadRpgProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingGmUploadRpgProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "GmUploadRpgProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingGmUploadRpgProject = false;
        ...
        public static bool IsRequstingInternalUploadAdventureProjectList {
            get { return _isRequstingInternalUploadAdventureProjectList; }
        }
        private static bool _isRequstingInternalUploadAdventureProjectList = false;
        /// <summary>
		/// 上传冒险关卡列表
		/// </summary>
		/// <param name="dataList">所有关卡</param>
        public static void InternalUploadAdventureProjectList (
            List<Msg_InternalUpdateAdventureProjectItem> dataList,
            Action<Msg_SC_CMD_InternalUploadAdventureProjectList> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingInternalUploadAdventureProjectList) {
                return;
            }
            _isRequstingInternalUploadAdventureProjectList = true;
            Msg_CS_CMD_InternalUploadAdventureProjectList msg = new Msg_CS_CMD_InternalUploadAdventureProjectList();
            // 上传冒险关卡列表
            msg.DataList.AddRange(dataList);
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_InternalUploadAdventureProjectList>(
                SoyHttpApiPath.InternalUploadAdventureProjectList, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingInternalUploadAdventureProjectList = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "InternalUploadAdventureProjectList", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingInternalUploadAdventureProjectList = false;
        ...
        public static bool IsRequstingInternalUploadAdventureProject {
            get { return _isRequstingInternalUploadAdventureProject; }
        }
        private static bool _isRequstingInternalUploadAdventureProject = false;
        /// <summary>
		/// 上传冒险关卡
		/// </summary>
		/// <param name="projectData">关卡数据</param>
        public static void InternalUploadAdventureProject (
            Msg_SC_DAT_Project projectData,
            Action<Msg_SC_CMD_InternalUploadAdventureProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingInternalUploadAdventureProject) {
                return;
            }
            _isRequstingInternalUploadAdventureProject = true;
            Msg_CS_CMD_InternalUploadAdventureProject msg = new Msg_CS_CMD_InternalUploadAdventureProject();
            // 上传冒险关卡
            msg.ProjectData = projectData;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_InternalUploadAdventureProject>(
                SoyHttpApiPath.InternalUploadAdventureProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingInternalUploadAdventureProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "InternalUploadAdventureProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingInternalUploadAdventureProject = false;
        ...
        public static bool IsRequstingInternalPublishAdventureProject {
            get { return _isRequstingInternalPublishAdventureProject; }
        }
        private static bool _isRequstingInternalPublishAdventureProject = false;
        /// <summary>
		/// 发布冒险关卡
		/// </summary>
		/// <param name="publishTime">定时</param>
        public static void InternalPublishAdventureProject (
            long publishTime,
            Action<Msg_SC_CMD_InternalPublishAdventureProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingInternalPublishAdventureProject) {
                return;
            }
            _isRequstingInternalPublishAdventureProject = true;
            Msg_CS_CMD_InternalPublishAdventureProject msg = new Msg_CS_CMD_InternalPublishAdventureProject();
            // 发布冒险关卡
            msg.PublishTime = publishTime;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_InternalPublishAdventureProject>(
                SoyHttpApiPath.InternalPublishAdventureProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingInternalPublishAdventureProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "InternalPublishAdventureProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingInternalPublishAdventureProject = false;
        ...
        public static bool IsRequstingInternalUploadNetProjectList {
            get { return _isRequstingInternalUploadNetProjectList; }
        }
        private static bool _isRequstingInternalUploadNetProjectList = false;
        /// <summary>
		/// 上传多人关卡列表
		/// </summary>
		/// <param name="dataList">所有关卡</param>
        public static void InternalUploadNetProjectList (
            List<long> dataList,
            Action<Msg_SC_CMD_InternalUploadNetProjectList> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingInternalUploadNetProjectList) {
                return;
            }
            _isRequstingInternalUploadNetProjectList = true;
            Msg_CS_CMD_InternalUploadNetProjectList msg = new Msg_CS_CMD_InternalUploadNetProjectList();
            // 上传多人关卡列表
            msg.DataList.AddRange(dataList);
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_InternalUploadNetProjectList>(
                SoyHttpApiPath.InternalUploadNetProjectList, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingInternalUploadNetProjectList = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "InternalUploadNetProjectList", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingInternalUploadNetProjectList = false;
        ...
        public static bool IsRequstingInternalUploadNetProject {
            get { return _isRequstingInternalUploadNetProject; }
        }
        private static bool _isRequstingInternalUploadNetProject = false;
        /// <summary>
		/// 上传多人关卡
		/// </summary>
		/// <param name="projectData">关卡数据</param>
        public static void InternalUploadNetProject (
            Msg_SC_DAT_Project projectData,
            Action<Msg_SC_CMD_InternalUploadNetProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingInternalUploadNetProject) {
                return;
            }
            _isRequstingInternalUploadNetProject = true;
            Msg_CS_CMD_InternalUploadNetProject msg = new Msg_CS_CMD_InternalUploadNetProject();
            // 上传多人关卡
            msg.ProjectData = projectData;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_InternalUploadNetProject>(
                SoyHttpApiPath.InternalUploadNetProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingInternalUploadNetProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "InternalUploadNetProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingInternalUploadNetProject = false;
        ...
        public static bool IsRequstingInternalPublishNetProject {
            get { return _isRequstingInternalPublishNetProject; }
        }
        private static bool _isRequstingInternalPublishNetProject = false;
        /// <summary>
		/// 发布多人关卡
		/// </summary>
		/// <param name="projectData">关卡数据</param>
        public static void InternalPublishNetProject (
            Msg_SC_DAT_Project projectData,
            Action<Msg_SC_CMD_InternalPublishNetProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingInternalPublishNetProject) {
                return;
            }
            _isRequstingInternalPublishNetProject = true;
            Msg_CS_CMD_InternalPublishNetProject msg = new Msg_CS_CMD_InternalPublishNetProject();
            // 发布多人关卡
            msg.ProjectData = projectData;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_InternalPublishNetProject>(
                SoyHttpApiPath.InternalPublishNetProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingInternalPublishNetProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "InternalPublishNetProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingInternalPublishNetProject = false;
        ...
        public static bool IsRequstingInternalUploadRpgProjectList {
            get { return _isRequstingInternalUploadRpgProjectList; }
        }
        private static bool _isRequstingInternalUploadRpgProjectList = false;
        /// <summary>
		/// 上传剧情关卡列表
		/// </summary>
		/// <param name="dataList">所有关卡</param>
        public static void InternalUploadRpgProjectList (
            List<long> dataList,
            Action<Msg_SC_CMD_InternalUploadRpgProjectList> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingInternalUploadRpgProjectList) {
                return;
            }
            _isRequstingInternalUploadRpgProjectList = true;
            Msg_CS_CMD_InternalUploadRpgProjectList msg = new Msg_CS_CMD_InternalUploadRpgProjectList();
            // 上传剧情关卡列表
            msg.DataList.AddRange(dataList);
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_InternalUploadRpgProjectList>(
                SoyHttpApiPath.InternalUploadRpgProjectList, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingInternalUploadRpgProjectList = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "InternalUploadRpgProjectList", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingInternalUploadRpgProjectList = false;
        ...
        public static bool IsRequstingInternalUploadRpgProject {
            get { return _isRequstingInternalUploadRpgProject; }
        }
        private static bool _isRequstingInternalUploadRpgProject = false;
        /// <summary>
		/// 上传剧情关卡
		/// </summary>
		/// <param name="projectData">关卡数据</param>
        public static void InternalUploadRpgProject (
            Msg_SC_DAT_Project projectData,
            Action<Msg_SC_CMD_InternalUploadRpgProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingInternalUploadRpgProject) {
                return;
            }
            _isRequstingInternalUploadRpgProject = true;
            Msg_CS_CMD_InternalUploadRpgProject msg = new Msg_CS_CMD_InternalUploadRpgProject();
            // 上传剧情关卡
            msg.ProjectData = projectData;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_InternalUploadRpgProject>(
                SoyHttpApiPath.InternalUploadRpgProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingInternalUploadRpgProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "InternalUploadRpgProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingInternalUploadRpgProject = false;
        ...
        public static bool IsRequstingInternalPublishRpgProject {
            get { return _isRequstingInternalPublishRpgProject; }
        }
        private static bool _isRequstingInternalPublishRpgProject = false;
        /// <summary>
		/// 发布剧情关卡
		/// </summary>
		/// <param name="projectData">关卡数据</param>
        public static void InternalPublishRpgProject (
            Msg_SC_DAT_Project projectData,
            Action<Msg_SC_CMD_InternalPublishRpgProject> successCallback, Action<ENetResultCode> failedCallback,
            UnityEngine.WWWForm form = null) {

            if (_isRequstingInternalPublishRpgProject) {
                return;
            }
            _isRequstingInternalPublishRpgProject = true;
            Msg_CS_CMD_InternalPublishRpgProject msg = new Msg_CS_CMD_InternalPublishRpgProject();
            // 发布剧情关卡
            msg.ProjectData = projectData;
            NetworkManager.AppHttpClient.SendWithCb<Msg_SC_CMD_InternalPublishRpgProject>(
                SoyHttpApiPath.InternalPublishRpgProject, msg, ret => {
                    if (successCallback != null) {
                        successCallback.Invoke(ret);
                    }
                    _isRequstingInternalPublishRpgProject = false;
                }, (failedCode, failedMsg) => {
                    LogHelper.Error("Remote command error, msg: {0}, code: {1}, info: {2}", "InternalPublishRpgProject", failedCode, failedMsg);
                    if (failedCallback != null) {
                        failedCallback.Invoke(failedCode);
                    }
                    _isRequstingInternalPublishRpgProject = false;
