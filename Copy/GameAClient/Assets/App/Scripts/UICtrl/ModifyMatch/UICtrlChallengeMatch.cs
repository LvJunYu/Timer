...
//        private EChallengeProjectType _selectChallengeTemp;
        ...
        protected override void InitEventListener()
        {
            ...
            Messenger<EChallengeProjectType>.AddListener(EMessengerType.OnChallengeProjectSelected,
                OnChallengeProjectSelected);
        ...
        public override void OnUpdate()
        {
            ...
            if (_randomPickTimer > 0)
            {
                ...
                if (_randomPickTimer <= 0)
                {
                    if (LocalUser.Instance.MatchUserData.CurrentChallengeState() ==
                        MatchUserData.EChallengeState.Selecting)
                    {
                        if (_isOpen)
                            Refresh();
                        _cachedView.InputBlock.gameObject.SetActive(false);
        ...
        private void Refresh()
        {
            ...
            else if (LocalUser.Instance.MatchUserData.CurrentChallengeState() ==
                     MatchUserData.EChallengeState.Selecting)
            {
                _easyCard.SetProject(LocalUser.Instance.MatchUserData.EasyChallengeProjectData,
                    EChallengeProjectType.CPT_Easy);
                _normalCard.SetProject(LocalUser.Instance.MatchUserData.MediumChallengeProjectData,
                    EChallengeProjectType.CPT_Medium);
                _hardCard.SetProject(LocalUser.Instance.MatchUserData.DifficultChallengeProjectData,
                    EChallengeProjectType.CPT_Difficult);
                _unkownCard.SetProject(LocalUser.Instance.MatchUserData.RandomChallengeProjectData,
                    EChallengeProjectType.CPT_Random);
...
//                _selectChallengeTemp = EChallengeProjectType.CPT_None;
                     ...
                     MatchUserData.EChallengeState.Challenging)
            {
                _easyCard.SetProject(LocalUser.Instance.MatchUserData.EasyChallengeProjectData,
                    EChallengeProjectType.CPT_Easy,
                    LocalUser.Instance.MatchUserData.CurSelectedChallengeType == (int) EChallengeProjectType.CPT_Easy
                        ? 1
                        : -1);
                _normalCard.SetProject(LocalUser.Instance.MatchUserData.MediumChallengeProjectData,
                    EChallengeProjectType.CPT_Medium,
                    LocalUser.Instance.MatchUserData.CurSelectedChallengeType == (int) EChallengeProjectType.CPT_Medium
                        ? 1
                        : -1);
                _hardCard.SetProject(LocalUser.Instance.MatchUserData.DifficultChallengeProjectData,
                    EChallengeProjectType.CPT_Difficult,
                    LocalUser.Instance.MatchUserData.CurSelectedChallengeType ==
                    (int) EChallengeProjectType.CPT_Difficult
                        ? 1
                        : -1);
                _unkownCard.SetProject(LocalUser.Instance.MatchUserData.RandomChallengeProjectData,
                    EChallengeProjectType.CPT_Random,
                    LocalUser.Instance.MatchUserData.CurSelectedChallengeType == (int) EChallengeProjectType.CPT_Random
                        ? 1
                        : -1);
                _cachedView.RandomPickBtn.gameObject.SetActive(false);
                ...
                _cachedView.SelectTip.gameObject.SetActive(false);
                _cachedView.ChallengeEnergyCost.text =
                    string.Format("-{0}", LocalUser.Instance.MatchUserData.CurMatchChallengeCount);
            }
            else
            {
...
//		}
        ...
        {
            if (MatchUserData.EChallengeState.Challenging !=
                LocalUser.Instance.MatchUserData.CurrentChallengeState()) return;
        ...
        private void OnRandomPickBtn()
        {
            ...
            RemoteCommands.GetMatchChallengeProject(0, msg =>
                {
                    if ((int) EGetMatchChallengeProjectCode.GMCPC_Success == msg.ResultCode)
                    {
                        LocalUser.Instance.MatchUserData.EasyChallengeProjectData.OnSyncFromParent(
                            msg.EasyChallengeProjectData);
                        LocalUser.Instance.MatchUserData.MediumChallengeProjectData.OnSyncFromParent(
                            msg.MediumChallengeProjectData);
                        LocalUser.Instance.MatchUserData.DifficultChallengeProjectData.OnSyncFromParent(
                            msg.DifficultChallengeProjectData);
                        LocalUser.Instance.MatchUserData.RandomChallengeProjectData.OnSyncFromParent(
                            msg.RandomChallengeProjectData);
                        LocalUser.Instance.MatchUserData.LeftChallengeCount--;
                        LocalUser.Instance.MatchUserData.CurSelectedChallengeType =
                            (int) EChallengeProjectType.CPT_None;
                    }
                    else
                    {
