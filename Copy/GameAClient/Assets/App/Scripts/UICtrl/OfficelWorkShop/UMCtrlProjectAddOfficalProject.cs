...
namespace GameA
{
    public class UMCtrlProjectAddOfficalProject : UMCtrlBase<UMViewProjectSelfCommend>, IDataItemRenderer
    {
        ...
        protected override void OnViewCreated()
        {
            ...
            _cachedView.AddProjectBtn.onClick.AddListener(OnAddBtn);
        }
        ...
        {
            SocialGUIManager.Instance.GetUI<UICtrlOfficalWorkShop>().OnAddSelectBtn(_wrapper.Content);
            _cachedView.UnSelectBtn.SetActiveEx(true);
        }

        private void OnUnSelectBtn()
        {
            SocialGUIManager.Instance.GetUI<UICtrlOfficalWorkShop>().OnAddUnSelectBtn(_wrapper.Content);
            _cachedView.UnSelectBtn.SetActiveEx(false);
        }
