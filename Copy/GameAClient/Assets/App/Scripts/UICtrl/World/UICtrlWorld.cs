...
namespace GameA
{
    ...
    public class UICtrlWorld : UICtrlAnimationBase<UIViewWorld>
    {
        ...
        private UPCtrlWorldOfficalSelectGM _upCtrlWorldOfficalSelectProjectGm;
        public UPCtrlWorldCandidate UpCtrlWorldCandidate;
        ...
        protected override void OnViewCreated()
        {
            ...
            var upCtrlWorldOfficalSelectProject = new UPCtrlWorldOfficalSelect();
            upCtrlWorldOfficalSelectProject.Set(ResScenary);
            upCtrlWorldOfficalSelectProject.SetMenu(EMenu.OfficalSelect);
            upCtrlWorldOfficalSelectProject.Init(this, _cachedView);
            _menuCtrlArray[(int) EMenu.OfficalSelect] = upCtrlWorldOfficalSelectProject;

            _upCtrlWorldOfficalSelectProjectGm = new UPCtrlWorldOfficalSelectGM();
            _upCtrlWorldOfficalSelectProjectGm.Set(ResScenary);
            _upCtrlWorldOfficalSelectProjectGm.SetMenu(EMenu.OfficalSelectGM);
            _upCtrlWorldOfficalSelectProjectGm.Init(this, _cachedView);
            _menuCtrlArray[(int) EMenu.OfficalSelectGM] = _upCtrlWorldOfficalSelectProjectGm;

            UpCtrlWorldCandidate = new UPCtrlWorldCandidate();
            UpCtrlWorldCandidate.Set(ResScenary);
            UpCtrlWorldCandidate.Init(this, _cachedView);
            ...
            _menuCtrlArray[(int) EMenu.OfficalSelectGM].Close();
        ...
        protected override void OnOpen(object parameter)
        {
            ...
            {
                _cachedView.TabGroup.SelectIndex((int) EMenu.OfficalSelect, true);
            }
            else
            {
        ...
        private void ChangeMenu(EMenu menu)
        {
            ...
            if (inx < _menuCtrlArray.Length)
            {
                ...
                if (_curMenu == EMenu.OfficalSelect)
                {
                    if (OfficalData.Instance.IsGmModle)
                    {
                        _curMenuCtrl = _menuCtrlArray[(int) EMenu.OfficalSelectGM];
                        _curMenu = EMenu.OfficalSelectGM;
                    }
                }
            }
        ...
        public void OnSelectGMProject(long projectID)
        {
            _upCtrlWorldOfficalSelectProjectGm.RemoveProjectList.Add(projectID);
        }

        public void OnUnSelectGMProject(long projectID)
        {
            _upCtrlWorldOfficalSelectProjectGm.RemoveProjectList.Remove(projectID);
        }

        public void OnSelectGMCanditateProject(long projectID)
        {
            UpCtrlWorldCandidate.OpsrateProjectList.Add(projectID);
        }

        public void OnUnSelectGMCanditateProject(long projectID)
        {
            UpCtrlWorldCandidate.OpsrateProjectList.Remove(projectID);
        }

        public void OnDragEnd(int oldIndex, int newIndex)
        {
            _upCtrlWorldOfficalSelectProjectGm.OnUmProjectDragEnd(oldIndex, newIndex);
        }
