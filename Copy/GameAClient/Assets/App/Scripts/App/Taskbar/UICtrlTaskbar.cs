...
//            _cachedView.ChatBtn.onClick.AddListener(OnChatBtn);
            ...
            _cachedView.OfficelWorkShopBtn.onClick.AddListener(OnOpenOfficalWorkShop);
            _cachedView.OpenGMBtn.onClick.AddListener(OnOpenGMBtn);
            _cachedView.CloseGMBtn.onClick.AddListener(OnCloseGMBtn);
            _cachedView.AdminBtn.onClick.AddListener(OnAdminBtn);
        }
...
//                SocialGUIManager.Instance.OpenUI<UICtrlCharacterUpgrade>();
        ...
        private void RefreshUserInfo()
        {
            ...
            //GM
            _cachedView.OfficelWorkShopObject.SetActiveEx((LocalUser.Instance.User.RoleType ==
                                                           (int) EAccountRoleType.AcRT_Admin ||
                                                           LocalUser.Instance.User.RoleType ==
                                                           (int) EAccountRoleType.AcRT_GameMaster) &&
                                                          OfficalData.Instance.IsGmModle);
            _cachedView.AdminObj.SetActiveEx(LocalUser.Instance.User.RoleType ==
                                             (int) EAccountRoleType.AcRT_Admin ||
                                             LocalUser.Instance.User.RoleType ==
                                             (int) EAccountRoleType.AcRT_GameMaster);
            _cachedView.OpenGMBtn.SetActiveEx(!OfficalData.Instance.IsGmModle);
            _cachedView.CloseGMBtn.SetActiveEx(OfficalData.Instance.IsGmModle);
        }
...
//            else
        ...
        private void OnOpenOfficalWorkShop()
        {
            SocialGUIManager.Instance.OpenUI<UICtrlOfficalWorkShop>();
        }

        private void OnOpenGMBtn()
        {
            _cachedView.CloseGMBtn.SetActiveEx(true);
            _cachedView.OpenGMBtn.SetActiveEx(false);
            OfficalData.Instance.IsGmModle = true;
            _cachedView.OfficelWorkShopObject.SetActiveEx((LocalUser.Instance.User.RoleType ==
                                                           (int) EAccountRoleType.AcRT_Admin ||
                                                           LocalUser.Instance.User.RoleType ==
                                                           (int) EAccountRoleType.AcRT_GameMaster) &&
        ...
        {
            _cachedView.CloseGMBtn.SetActiveEx(false);
            _cachedView.OpenGMBtn.SetActiveEx(true);
            OfficalData.Instance.IsGmModle = false;
            _cachedView.OfficelWorkShopObject.SetActiveEx((LocalUser.Instance.User.RoleType ==
                                                           (int) EAccountRoleType.AcRT_Admin ||
                                                           LocalUser.Instance.User.RoleType ==
                                                           (int) EAccountRoleType.AcRT_GameMaster) &&
        ...
        private void OnAdminBtn()
        {
            SocialGUIManager.Instance.OpenUI<UICtrlGMInfor>();
        }
