...
namespace GameA.Game
{
    public class SkillBlock : BlockBase
    {
        public override bool OnLeftHit(UnitBase other, ref int x, bool checkOnly = false)
        {
            if (other.IsActor)
            {
                var min = new IntVec2(ColliderGrid.XMin, other.CenterPos.y);
        ...
        public override bool OnDownHit(UnitBase other, ref int y, bool checkOnly = false)
        {
            if (other.IsActor)
            {
                var min = new IntVec2(other.CenterPos.x, ColliderGrid.YMin);
        ...
        public override void Hit(UnitBase other, EDirectionType eDirectionType)
        {
