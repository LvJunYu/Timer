...
namespace GameA.Game
{
    public class PlayerBase : ActorBase
    {
        ...
        {
            Messenger.AddListener(EMessengerType.OnChangeToAppMode, ResetShaderValue);
            Messenger.AddListener(EMessengerType.OnApplicationQuit, ResetShaderValue);
            return base.OnInit();
        }
...
//            _maxSpeedX = BattleDefine.MaxSpeedX;
        ...
        public override UnitExtraDynamic UpdateExtraData(UnitExtraDynamic unitExtraDynamic = null)
        {
            ...
            _injuredReduce = TableConvert.GetInjuredReduce(_unitExtra.InjuredReduce);
            _curIncrease = TableConvert.GetCurIncrease(_unitExtra.CureIncrease);
            return _unitExtra;
        }
        ...
        protected virtual void CheckBox()
        {
            if (IsHoldingBox())
            {
                if (ColliderGrid.YMin != _box.ColliderGrid.YMin || 
        ...
        {
            return unit != null && unit is Box && unit.ColliderGrid.YMin == ColliderGrid.YMin &&
...
//            _jumpState = EJumpState.Jump1;
        ...
        {
            Messenger.RemoveListener(EMessengerType.OnChangeToAppMode, ResetShaderValue);
            Messenger.RemoveListener(EMessengerType.OnApplicationQuit, ResetShaderValue);
            base.Dispose();
        }
        ...
        protected override bool CheckRopeVerticalFloor(int deltaPosY = 0)
        {
            ...
            Grid2D grid = new Grid2D(ColliderGrid.XMin - _ropeOffset.x, ColliderGrid.YMin - _ropeOffset.y,
                ColliderGrid.XMax - _ropeOffset.x, ColliderGrid.YMax - _ropeOffset.y);
