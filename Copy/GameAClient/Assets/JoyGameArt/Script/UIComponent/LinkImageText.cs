...
//            s_TextBuilder.Append("</color>");
    ...
    {
        get { return cachedTextGeneratorForLayout.GetPreferredWidth(m_OutputText, GetGenerationSettings(Vector2.zero)) / pixelsPerUnit; }
    }

    public override float preferredHeight
    {
        get { return cachedTextGeneratorForLayout.GetPreferredHeight(m_OutputText, GetGenerationSettings(new Vector2(GetPixelAdjustedRect().size.x, 0.0f))) / pixelsPerUnit; }
    }
