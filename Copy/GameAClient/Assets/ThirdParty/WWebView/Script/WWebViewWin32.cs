...
public class WWebViewWin32
{
    ...
    [DllImport("Win32-WebView", CharSet = CharSet.Auto)]
    public static extern void CleanCache(string url);

    [DllImport("Win32-WebView", CharSet = CharSet.Auto)]
    public static extern void CleanCookie(string url);
    ...
    [DllImport("Win32-WebView", CharSet = CharSet.Auto)]
    public static extern void ChangeInsets(string name, int left, int top, int right, int bottom, int width, int height);
    ...
    {
        // NOTE: DO NOT call following method.
        // result = DefWindowProc(window, message, wparam, lparam);
