...
public class Gesture : BaseFinger,ICloneable{
	...
	public override string ToString()
	{
		return string.Format(
			"Swipe: {0}, SwipeLength: {1}, SwipeVector: {2}, DeltaPinch: {3}, TwistAngle: {4}," +
			" TwoFingerDistance: {5}, Type: {6}, {7}",
			swipe, swipeLength, swipeVector, deltaPinch, twistAngle, twoFingerDistance, type, base.ToString());
	}
}
}
